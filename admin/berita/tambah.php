...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($judul)) {
        ...
        if (empty($error)) {
            ...
            if (insert($conn, 'berita', $data)) {
                // Log aktivitas
                $conn->query("INSERT INTO log_aktivitas (user_id, tipe, deskripsi) VALUES ($user_id, 'create', 'Menambahkan berita baru: $judul')");
...
<head>
    ...
    <title>Tambah Berita - Puskesmas Kepulauan Seribu Selatan</title>
